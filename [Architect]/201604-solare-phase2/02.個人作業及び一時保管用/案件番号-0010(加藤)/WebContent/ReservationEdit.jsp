...
<div class="msg"><s:property value="message" /></div>
	...
	<div class="contents">
		...
		<table class="table">
            <caption style="color:#ffffff;">reservation <s:property value="customerReservationNumber" /></caption>
			<tr>
				...
				<tr>
					...
					<td><select name="customerReservationNumber"
						class="easy-select-box">
							<s:iterator value="reservationInfoList">
								<option value="<s:property value="customerReservationNumber" />"><s:property value="customerReservationNumber" /></option>
							</s:iterator>
					</select></td>
				</tr>
				<tr>
