...
<body>
	...
	<div class="contents">
		...
		<table class="table">
            <caption style="color:#ffffff;">Reservation Information <s:property value="customerReservationNumber" /></caption>
			<tr>
				<th class="item">Reservation No.</th>
				<td class="field"><font color="black"><s:property value="customerReservationNumber" /></font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="field"><font color="black"><s:property value="courseNumberString" /></font></td>
			</tr>
		...
		<table id="center">
			<tr>
				...
				<button class="button4">Return</button>
						<!--<button data-icon="♛" class="button pink serif round glass">Return</button>-->
					</s:form></th>
				<td><s:form action="ReservationEditCompleteAction">
					<input type=hidden name="customerReservationNumber"value="<s:property value="customerReservationNumber" />">
					<input type=hidden name="reservationDate"value="<s:property value="reservationDate" />">
					<input type=hidden name="reservationDateString"value="<s:property value="reservationDateString" />">
					...
					<button class="button4">Decide</button>
						<!--<button data-icon="♛" class="button pink serif round glass">Decide</button>-->
					</s:form></td>
			</tr>
		</table>
	</div>
