			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="name" value="" placeholder="野比"
						maxlength="24" required />姓 <input type="text" name="name" value=""
						placeholder="のびた" maxlength="25"required />名</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="nameF" value="" placeholder="のび"
						maxlength="24" required />せい <input type="text" name="nameF" value=""
						placeholder="のびた" maxlength="25" required />めい</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="address" id="address1" maxlength="10" required>都道府県
						<input type="text" name="address" id="address2" maxlength="15" required>市区町村
				...
				<tr>
					...
					<td><input type="text" name="email"
						pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"  maxlength="50" required
