...
<meta name="viewport"
  content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0,user-scalable=nc">
<title>検索結果一覧</title>
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        <s:iterator value="usersList" status="i">
          ...
          <s:if test='#flag == 1'>
            <s:if
              test="%{#session.userId != usersList.get(#i.index).userId}">
              ...
              <div class="friends-container">
                <div class="userbox">
                  <a
                    ...
                    <img class="profimg"
                    src="<s:property value="usersList.get(#i.index).userIcon"/>"
                    alt=""> <s:property
                ...
                <div class="follow-btn">
                  ...
                  <s:else>
                    <div class="square_btn">
                      <a href="<s:url action="AddGroupMemberAction">
                      <s:param name="addMemberList" value="usersList.get(#i.index).userId"/></s:url>">
                        グループに追加する
                      </a>
                    </div>
                  </s:else>
