...
public class ScheduleUpdateDAO {
	 ...
	 * @return count
	 */
	public int update(int id, String startDay, String endDay, String title, String comment){
		int count=0;
		...
		String sql = "UPDATE schedule SET start_day=?, end_day=?, title=?, memo_text=? WHERE id=?";
