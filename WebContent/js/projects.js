...
$(function(){
	  //テキストリンクをクリックしたら
	    ...
	    //モーダルウィンドウを表示
			...
			var startdate = $('.projectStartdate').eq(index).val();
...
$(function(){
	  //テキストリンクをクリックしたら
	    ...
	    //モーダルウィンドウを表示
			...
			var plan = $('.search-projectPlanlist').eq(index).val();
			$('#delete-projectplan').val( plan );

			var result = $('.search-projectResultlist').eq(index).val();
			$('#delete-projectresult').val( result );

			var other = $('.searchotherlist').eq(index).val();
