...
end_date date default 0 comment '終了日',
...
project_id int not null comment 'プロジェクトID',
a_envstart date default 0 comment 'A環境開始日',
a_envend date default 0 comment 'A環境終了日',
b_envstart date default 0 comment 'B環境開始日',
b_envend date default 0 comment 'B環境終了日',
r_envstart date default 0 comment 'リリース環境開始日',
r_envend date default 0 comment 'リリース環境終了日',
...
CREATE TABLE user (
  ...
  `birthday` date NOT NULL DEFAULT 0 COMMENT '誕生日',
  `handle_name` varchar(16) DEFAULT NULL COMMENT 'ハンドルネーム',
  `register_day` datetime NOT NULL DEFAULT 0 COMMENT '登録日',
  `update_day` datetime NOT NULL DEFAULT 0 COMMENT '更新日',
...
birthday date default 0 comment '誕生日',
...
register_day datetime default 0 comment '登録日',
update_day datetime default 0 comment '更新日'
)comment = 'ユーザー情報格納テーブル';
