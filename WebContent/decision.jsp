...
承認者3
			...
			<table class="sub visible-xs" border="2">
				...
				<tr>
					...
					<s:if test="decisionList != null && !decisionList.isEmpty()">
						<s:iterator value="decisionList">
							<td><input type="number" readonly="readonly" size="20"
								class="w67" value="<s:property value="totalProve"/>"></td>
						</s:iterator>
					</s:if>
					<s:else>
						<td><input type="number" readonly="readonly" size="20"
				...
				<tr>
					...
					<s:if test="decisionList != null && !decisionList.isEmpty()">
						<s:iterator value="decisionList">
							<td><input type="number" readonly="readonly" name="re"
								class="w67" value="<s:property value="re" />"></td>
						</s:iterator>
					</s:if>
					<s:else>
						<td><input type="number" readonly="readonly" name="re"
					...
					<s:else>
						<td><input type="number" id="res" class="w67" value=""
							readonly="readonly"></td>
					</s:else>
					<s:if test="decisionList != null && !decisionList.isEmpty()">
						<s:iterator value="decisionList">
				...
				<tr>
					...
					<s:if test="decisionList != null && !decisionList.isEmpty()">
						<s:iterator value="decisionList">
							<td><input type="number" readonly="readonly" name="line"
								class="w67" value="<s:property value="line" />"></td>
						</s:iterator>
					</s:if>
					<s:else>
						<td><input type="number" readonly="readonly" name="line"
					...
					<s:if test="decisionList != null && !decisionList.isEmpty()">
						<s:iterator value="decisionList">
							<td><input type="number" size="20" class="w67"
								readonly="readonly" value="<s:property value="totalLine"/>">万円</td>
						</s:iterator>
					</s:if>
					<s:else>
						<td><input type="number" size="20" class="w67"
							readonly="readonly" value="">万円</td>
					</s:else>
				</tr>
				...
				<tr>
					...
					<s:if test="decisionList != null && !decisionList.isEmpty()">
						<s:iterator value="decisionList">
							<td><input type="number" readonly="readonly" name="room"
								class="w67" value="<s:property value="room" />"></td>
						</s:iterator>
					</s:if>
					<s:else>
						<td><input type="number" readonly="readonly" name="room"
					...
					<s:if test="decisionList != null && !decisionList.isEmpty()">
						<s:iterator value="decisionList">
							<td><input type="number" value="1" class="w67"
								readonly="readonly"></td>
						</s:iterator>
					</s:if>
					<s:else>
				...
				<tr>
					...
					<td><s:if
							test="decisionList != null && !decisionList.isEmpty()">
							<s:iterator value="decisionList">
								<input type="number" class="w67"
									value="<s:property value="bildCost"/>" size="20"
									readonly="readonly">万円
</s:iterator>
						</s:if> <s:else>
			...
			<table class="math visible-xs" border="2">
				...
				<tr>
					...
					<s:else>
						<td><input type="number" id="c" class="w67" value=""
							readonly="readonly"></td>
					</s:else>
					<s:if test="decisionList != null && !decisionList.isEmpty()">
						<s:iterator value="decisionList">
				...
				<tr>
					...
					<s:else>
						<td><input type="number" id="d" class="w67" value=""
							readonly="readonly"></td>
					</s:else>
					<s:if test="decisionList != null && !decisionList.isEmpty()">
						<s:iterator value="decisionList">
				...
				<tr>
					...
					<s:else>
						<td><input type="number" class="w67" value=""
							readonly="readonly" size="20">万円</td>
					</s:else>
				</tr>
			</table>
