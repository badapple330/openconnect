 ...
 *
 */
public class ChangeColorAction extends ActionSupport implements SessionAware{
	...
	*/
	...
	public String execute() {
		ChangeColorDAO dao = new ChangeColorDAO();
		String result = ERROR;
		...
		dao.changeColor( userId, ColorH,ColorB,ColorF);
