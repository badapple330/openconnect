			...
			<div class="center">
				<table border="1">
					<tr>
						...
						<td><div class="center">プロジェクトID</div></td>
					...
					<s:iterator value="decisiontList">
						<tr>
							<td><input type="text" name="registration"
								value="<s:property value="registration" />" /></td>
							<td><input type="text" pattern="[1-9][0-9]*" maxlength="100"
