					...
					<s:iterator value="decisiontList">
						<tr>
							...
							<td><input type="text" pattern=\d{4}-\d{2}-\d{2}
								name="registration" value="<s:property value="registration" />" id="registration" /></td>
							<td><input type="text" pattern="[1-9][0-9]*" maxlength="11"
								required name="userId" value="<s:property value="userId" />" id="id" /></td>
							<td><input type="text" pattern="[1-9][0-9]*" maxlength="11"
								required name="userId" value="<s:property value="userId" />" id="id" /></td>
							<td><input type="text" pattern="[1-9][0-9]*" maxlength="11"
								required name="projectId" value="<s:property value="projectId" />" id="registration" /></td>
							...
							<td><input type="text" maxlength="255" name="detail" id="registration"
								value="<s:property value="detail" />" /></td>
							<td><input type="text" maxlength="100" name="iDraftingId" id="registration"
								value="<s:property value="iDraftingId" />" /></td>
							<td><input type="text" maxlength="100" name="iApprovalId" id="registration"
								value="<s:property value="iApprovalId" />" /></td>
							<td><input type="text" maxlength="100" name="aDraftingId" id="registration"
								value="<s:property value="aDraftingId" />" /></td>
							<td><input type="text" maxlength="100" name="cdId" id="registration"
								value="<s:property value="cdId" />" /></td>
							<td><input type="text" maxlength="100" name="iADId" id="registration"
								value="<s:property value="iADId" />" /></td>
							<td><input type="text" maxlength="100" name="iAId" id="registration"
