	...
	<table border="1">
		...
		<form >
			<s:iterator value="UserList">
				<tr>
					<td><input type="text" value="<s:property value="user_id" />"></td>
					<td><input type="text" value="<s:property value="name" />"></td>
					<td><input type="text" value="<s:property value="email" />"></td>
					<td><input type="checkbox" name="check"
						value="<s:property value="user_id" />"></td>
				</tr>
			</s:iterator>
	</table>
	<input type="submit" value="削除" name="AdminUserDelete">
	<input type="submit" value="編集" name="AdminUserEdit">
