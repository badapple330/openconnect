	...
	<table border="1">
		...
		<s:iterator value="decisionDetailList">
			<tr>
				...
				<td><input type="button" value="編集" class="editOpen"></td>
...
<s:form action="DecisionDetailEdit">
		<input type="text" name="password" ><br>
						以下の内容を編集でよろしいですか？
			<br>ID <input type="text" id="edit-projectid" readonly>
			<br>プロジェクト名<input type="text" id="edit-projectname" readonly>
			<br>決裁分類<input type="text" id="edit-classify" readonly>
			<br>申請・承認状況<input type="text" id="edit-status" readonly> <br>
				<input type="hidden" name="decisionDetailId" id="true-edit">
