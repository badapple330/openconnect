...
山では急に天候が変りやすく、雨で体が濡れると低体温症になってしまうことがあります。雨具を持っているかどうかで生死を分けると言ってもいいほど重要なアイテムなのです。',
'・リュック\n
...
'solo',
'ご自宅で高画質で映画、高音質で音楽が楽しめるホームシアターセット。\nリビングを劇場にしてみませんか？',
'ホームシアターの王道キット！',
'これで自宅でゆっくり楽しみましょう！',
'ホームシアターは映画や音楽ファンの憧れ。\n
...
'・テレビ\n
まずはこれがなくては始まりません。\n
こちらの４K対応の50インチ型のテレビはきめ細やかな描写や色彩を映し出し、作品のクオリティをありのままに表現します。',
'・プレイヤー\n
お好みの作品を再生するためにはプレイヤーも必要です。\n
ブルーレイ対応なのはもちろん、Netflixをはじめとする動画ストリーミングサービスにも対応しています。',
'・スピーカーセット\n
大迫力であり、繊細や音の響きまで伝えるスピーカーセットです。5.1ch対応なので臨場感が映画館顔負けです。',
'・アンプリファー\n
