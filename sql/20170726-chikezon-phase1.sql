...
price decimal(9,2) not null comment '単価',
store int comment '在庫',
image_path varchar(255) not null comment '画像パス',
heading text not null comment '見出し',
message text not null comment 'メッセージ',
is_deleted boolean not null default FALSE comment '削除フラグ(TRUEなら販売停止中)',
created_at datetime not null default current_timestamp comment '作成日',
updated_at datetime not null default current_timestamp comment '更新日'
);

-- goods テーブルサンプル挿入 --
insert into goods(goods_id,goods_name,price,store,image_path,heading,message) values
(1,"肩たたきチケット",1500,255,"img/肩たたき.jpg",
"決意を固めた僕の気持ち、君に届け――。",
"親愛なるご友人、仲間に渡しましょう。言葉では言えない日頃の感謝の気持ちを伝える橋渡しになるはずだ！"),

(2,"某ねずみの国片道チケット",5000,666666,"img/某ねずみの国.jpg",
"夢と希望に満ちた聖地へ、いざ行かん――。",
"某ねずみの国へ通じる道の許可証です！高いですが帰りの分も買う必要があります。"),

(3,"後楽園で僕と握手チケット",3000,801,"img/後楽園.jpg",
"人々の未来をつくり、世界に希望をもたらした英雄――。",
"後楽園で憧れの僕と握手できるチケットです。ぜひお買い求めを！そして僕と握手！"),

(4,"世界二周旅行券",20000,334,"img/世界二周.jpg",
"美しきこの世界を知り尽くす、渾身の覚悟――。",
"世界を十二分に見て知れる、超ロングの旅、世界二周ツアーへの参加券です！"),

(5,"雪かき体験チケット",5000,530000,"img/雪かき.jpg",
"重く降り積もった自然の力に抗え――。",
"雪を体で感じたいアナタにお勧め。がっつり雪をかきましょう！"),

(6,"ニトロサーカスチケット C席",4000,10,"img/ニトロサーカス.jpg",
"音も視界も爆炎で包み込む、爆発祭り――。",
"大量のニトロで芸術的で爆発的な演出が特徴のアメイジングなサーカスです！見に行こう！"),

(7,"黒鉛に導かれ者たちの宴(ダークカーニバル)チケット",1000,53,"img/ダークカーニバル.jpg",
"深遠なる闇の世界で互いを穿たん――。",
"国際舞台裏の闇をテーマにした、練り込まれた演劇が観客達を引き込む！"),

(8,"木村カエレコンサートチケット",100,931,"img/木村カエレ.jpg",
"魂震わし、大地をも震わす世界的歌手の凶宴――。",
"世界的歌手、木村カエレの魂震わすソウルコンサートチケットが今ならなんと100円です！"),

(9,"ぐなっしー写真撮影チケット",0,72,"img/ぐなっしー.jpg",
"大人気マスコットキャラクターぐなっしー。",
"巷で話題のぐなっしーと一緒に記念写真を撮れます。行きましょう！"),

(10,"10億!!PIG宝くじ",10000,810,"img/ピグくじ.jpg",
"自由を赦された世界には無限の可能性がある――",
"10億円当選チャンスのPIGなくじです。10億円の使い道に想像が膨らみます！"),

(11,"TEETO!2016ライブチケット",10000,2016,"img/TEETO.jpg",
"不屈の闘志をかき立てる、英雄の詩――。",
