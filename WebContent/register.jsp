	...
	<div align="center">
		...
		<s:if test="%{#session.userFlg >= 100}">
			...
			<table>
				...
				<tr>
					<th>名前（漢字）</th>
					<td><input type="text" name="familyNameKanji" value="" placeholder="苗字"
						maxlength="24" required /> <input type="text" name="givenNameKanji"
				...
				<tr>
					<th>名前（ふりがな）</th>
					<td><input type="text" name="familyNameKana" value="" placeholder="みょうじ"
						maxlength="24" required /> <input type="text" name="givenNameKana"
						value="" placeholder="なまえ" maxlength="25" required /></td>
				</tr>
				<!------------------    名前(英語)    ------------------->
				<tr>
					<th>名前（英語）</th>
					<td><input type="text" name="familyName" value="" placeholder="Family Name"
						maxlength="24" required /> <input type="text" name="givenName"
						value="" placeholder="Given Name" maxlength="25" required /></td>
				</tr>

				<!------------------    郵便番号    ------------------->
				<tr>
					<th>郵便番号</th>
					<td><input type="text" name="zip" size="10" maxlength="7" placeholder="1000000" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');">
<!-- 					<input type="text" name="postal" id="postcode1" -->
...
<!-- 						title="半角数字で入力してください"> -->
				...
				<tr>
					...
					<td><input type="text" name="address" id="address1"
						maxlength="60" required placeholder="住所" size="60">
<!-- 						 <input -->
...
<!-- 						name="address" maxlength="20" placeholder="建物名等" /> -->
				...
				<tr>
					...
					<td><input type="text" name="telNumber" value="" size="20"
						maxlength=11 pattern="^[0-9]+$" required title="半角数字で入力してください" placeholder="0312345678"/>
<!-- 						- -->
...
<!-- 						pattern="^[0-9]+$" required title="半角数字で入力してください" /> -->
				...
				<tr>
					...
					<td><input type="text" name="mobileNumber" value="" size="20"
						maxlength=11 pattern="^[0-9]+$" required title="半角数字で入力してください" placeholder="09012345678"/>
<!-- 						- -->
<!-- 						<input type="text" name="mobileNumber" value="" size="4" maxlength=4 -->
<!-- 						pattern="^[0-9]+$" required title="半角数字で入力してください" />- <input -->
...
<!-- 						pattern="^[0-9]+$" required title="半角数字で入力してください" /> -->
				...
				<tr>
					...
					<td><input type="text" name="mobileEmail"
						pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" maxlength="50"
						required title="example@ezweb.ne.jp" placeholder="example@ezweb.ne.jp"/></td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="year"
						pattern="([1-2][0-9]{3})" maxlength="4"
						required title="2016" placeholder="2016"/></td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="month"
						pattern="([0-1][0-9])" maxlength="2"
						required title="08" placeholder="08"/></td>
				</tr>
